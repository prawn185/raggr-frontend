...
<template>
    <div>
        ...
        <div v-if="flash.errors && Object.keys(flash.errors).length > 0" class="alert alert-danger">
            <ul>
        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <Notification :message="$page.props.flash.message" v-if="$page.props.flash.message" />
